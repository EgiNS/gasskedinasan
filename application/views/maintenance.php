...
<head>
    ...
    <title>GassEducation - Maintenance</title>
...
<body oncontextmenu="return false;">
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box;">
        ...
        <div class="empty-2-2 container mx-auto d-flex align-items-center justify-content-center flex-column"
            ...
            <img style="border-radius: 10%;" width="200" class="mb-3"
                src="<?= base_url('assets/img/Maintenance.png'); ?>" alt="">

            <div class="text-center w-100">
                <h1 class="title-text">
                    Opss! Website is Under Maintenance
                </h1>
            </div>
        </div>
    </section>
