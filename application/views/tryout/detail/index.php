        ...
        <div class="pc-content">
                        ...
                        <div class="card shadow-lg border-0 mt-3 rounded-4 overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                <?php if ($payment_status == 'pending'): ?>
                                    <button data-id="<?= $tryout['id'] ?>" type="button" class="w-100 btn btn-primary btn-lg rounded-pill shadow mx-auto" id="proceedPaymentDirect">
                                ...
                                <?php else : ?>
                                    <div class="d-grid gap-2 mb-3">
                                        ...
                                        <?php else : ?>
                                            ...
                                            <?php elseif ($tryout['paid'] == 0 && $tryout['freemium'] == 0): ?>
                                                <button type="button" class="btn btn-primary rounded-pill"
                                                    id="free-pay"
            ...
            <script>
                ...
                $(document).on('click', '#daftarBtn', function(e) {
                    ...
                    handlePayment(id, kode);

                });
                $(document).on('click', '#proceedPaymentDirect', function(e) {
                    e.preventDefault();
                    const id = <?= $tryout['id']; ?>;
                    console.log('Proceed direct payment for ID:', id);
                    handlePayment(id, '');

                });

                function handlePayment(id, kode) {
                    $.ajax({
