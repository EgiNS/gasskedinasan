        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="custom-file mt-1 mb-3 form-group">
                    <input type="file" class="form-control custom-file-input upload-bukti" required>
                ...
                <div class="custom-file mt-1 mb-3">
                    <input type="file" class="custom-file-input form-control upload-bukti" required>
                    <label class="custom-file-label text-danger" name="bukti" for="customFile">Unggah bukti</label>
                </div>
                ...
                <div class="custom-file mt-1">
                    <input type="file" multiple class="custom-file-input form-control upload-bukti" required>
                    <label class="custom-file-label text-danger" name="bukti" for="customFile">Unggah bukti</label>
                </div>
                <div class="custom-file mt-1">
                    <input type="file" class="custom-file-input form-control upload-bukti" required>
