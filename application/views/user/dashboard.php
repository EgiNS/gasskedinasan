      ...
      <div class="pc-content">
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="fs-5">Kedinasan impian: <span class="fw-bold text-warning"><?= $user->kedinasan_tujuan ? $user->kedinasan_tujuan : '<a href="editprofile">Pilih disini</a>' ?></span></div>
                </div>
                <div>
