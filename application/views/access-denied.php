...
<head>
    ...
    <title>Access Forbidden - <?= $company['name']; ?></title>
...
<body>
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #141432">
        ...
        <div class="empty-2-3 container mx-auto d-flex align-items-center justify-content-center flex-column"
            ...
            <img class="main-img blink-me" src="<?= base_url('assets/img/access-denied.png'); ?>" alt="Access Denied">
            <div class="text-center w-100">
                <h1 class="title-text text-white">Opss! Access Denied</h1>
                <p class="title-caption">
                    The page you’re looking for isn’t available for you. We<br class="d-sm-block d-none"> suggest you
                    Back to
                    Profile.
                </p>
                <div class="d-flex justify-content-center">
                    <a href="<?= base_url('user'); ?>" class="btn btn-back d-inline-flex text-white border-0">
                        Back to Profile
                    </a>
                </div>
            </div>
