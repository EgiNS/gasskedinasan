<style>
    ...
    .gk-li-size {
        ...
        @media (max-width: 992px) {
            ...
            .footer-kontak-content-section {
                width: 100% !important;
            }
        }
</style>
<div class="container-fluid gk-footer-bg text-white footer-section" style="padding: 50px 100px;">
    <div class="d-flex justify-content-around flex-column flex-lg-row footer-content-section" style="gap: 100px;">
