...
<div class="container-fluid why-bg d-flex justify-content-center align-items-center" style="padding: 0px 100px;">
    <div class="text-white w-50">
        ...
        <ul style="font-size: 20px; list-style-type: none; padding-left: 0; margin-top: 28px; line-height: 1.8;">
            <li>
                <span class="mr-2">
                    🎯
                </span> Materi sesuai kisi-kisi seleksi resmi
            </li>
            <li>
                <span class="mr-2">
                    🧠
                </span> Mentor profesional dan alumni sekolah kedinasan
            </li>
            <li>
                <span class="mr-2">
                    📈
                </span> Progress belajar terpantau otomatis
            </li>
            <li>
                <span class="mr-2">
                    🤝
                </span> Grup diskusi dan dukungan komunitas aktif
            </li>
        </ul>
    ...
    <div class="w-50 d-flex justify-content-center align-items-end">
        <img  style="max-width: 70%;" src="assets/assets_lp/img/gass/People_Image.png" alt="Foto Orang">
    </div>
