                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="icon_for_browser"
                    ...
                    <form action="<?= base_url('admin/settings?tab=token'); ?>" method="post">
                        ...
                        <div class="form-group row">
                            <label for="time_limit_for_activation" class="col-form-label">Time limit for Account
                                Activation</label>
                            <select class="custom-select" name="time_limit_for_activation"
                        ...
                        <div class="form-group row">
                            <label for="time_limit_for_reset_password" class="col-form-label">Time limit for Reset
                                Password</label>
                            <select class="custom-select" name="time_limit_for_reset_password"
                ...
                <div class="col-lg-6">
                    <form action="<?= base_url('admin/settings?tab=email'); ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="custom-select" name="mail_transport_type" id="mail_transport_type">
                ...
                <div class="col-lg-6">
                    <form action="<?= base_url('admin/settings?tab=midtrans'); ?>" method="POST">
                        <div class="form-group row">
                            ...
                            <select class="custom-select" name="environment" id="environment">
