   ...
   <?php
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <a href="#" class="btn btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#bobotSoalModal">Bobot
                Nilai</a>
            <?php endif; ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <form action="<?= base_url('admin/soallatsol/' . $slug . '?' . $page); ?>" method="post"
                            id="formbobotnilai">
