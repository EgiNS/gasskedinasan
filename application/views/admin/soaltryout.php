<style>
    /* Pastikan Swal muncul di depan modal Bootstrap */
.swal2-container {
   ...
   <div class="pc-container">
      ...
      <div class="pc-content">
        ...
        <div class="row">
          <!-- [ sample-page ] start -->
          <div class="col-sm-12">
            <a href="<?= base_url('admin/tambahsoal/' . $slug); ?>" class="btn rounded btn-sm btn-primary mb-3">Tambah Soal
                Baru</a>
            ...
            <a href="#" class="btn rounded btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#bobotSoalModal">Bobot
                Nilai</a>
            <?php endif; ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="bobotSoalModalLabel">Bobot Nilai <a id="lock-bobot" href="#"
                                class="<?= ($bobot == false ? 'd-none' : ''); ?>" data-kode="<?= $kode; ?>"><i
                                    class="ti ti-lock fs-3"></i></a> <a href="#" class="unlock-bobot d-none"><i
                                    class="ti ti-lock-open fs-3"></i></a></h4>
