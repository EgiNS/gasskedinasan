                        ...
                        <tbody>
                            <?php $i = 0; foreach ($pendaftar as $p) : ?>
                                <tr>
                                    ...
                                    <td><?= $p['created_at'] ?>
                                    <?php if ($p['status'] == 0) : ?>
                                        <td><span class="badge  bg-danger p-2">Belum Membayar</span></td>
                                    <?php elseif ($p['status'] == 1) : ?>
                                        <td><span class="badge  bg-warning p-2">Sudah Membayar</span></td>
                                    <?php elseif ($p['status'] == 2) : ?>
                                        <td><span class="badge  bg-success p-2  ">Terkonfirmasi</span></td>
                                    <?php endif; ?>
                                    <td>
